...
import { Search, Film, Tv, BookOpen, Gamepad2, ImageIcon, X, Check, Clock, ChevronDown } from 'lucide-react';
...
export function SearchAndSelect({ onSelect, selectedTitle }: SearchAndSelectProps) {
    ...
    const gameResults = results.filter((r) => r.category === 'game');
    ...
    return (
        <div ref={ containerRef } className="relative w-full">
          ...
          { selectedTitle || 'Keresés film, sorozat vagy könyv...' }
            ...
            {/* Expanded search */ }
            <div
                className={ `absolute top-full left-0 z-50 w-full mt-1 rounded-lg border border-input bg-popover shadow-lg ${ expanded ? '' : 'hidden' }` }>
                ...
                <div className="max-h-[300px] overflow-y-auto overscroll-contain p-3">
                    ...
                    { showSearchResults && (
                        <>
                            ...
                            { renderGroup('Játékok', gameResults) }
