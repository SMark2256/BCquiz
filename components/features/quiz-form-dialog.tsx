    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[85vh] sm:max-h-[90vh] w-[95vw] sm:max-w-2xl overflow-y-auto pb-20 pt-10 sm:py-10">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs sm:text-sm">
            {quiz
              ...
              : "Keress egy filmet, sorozatot vagy könyvet, majd add meg a részleteket."}
          </DialogDescription>
        </DialogHeader>
        ...
        >
          ...
          <div className="flex flex-col gap-1.5 sm:gap-2">
            <Label htmlFor="titleHu" className="text-xs sm:text-sm">
              Cím (magyar)
            </Label>
            <Input
              id="titleHu"
          ...
          <div className="flex flex-col gap-1.5 sm:gap-2">
            <Label htmlFor="imageUrl" className="text-xs sm:text-sm">
              Kép URL
            </Label>
            <Input
              id="imageUrl"
