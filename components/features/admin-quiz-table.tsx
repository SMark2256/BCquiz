...
import { Pencil, Trash2, Plus, MoreVertical, Calendar, Clock, Power, PowerOff } from 'lucide-react';
                        ...
                        <Card key={ quiz.id } className="relative overflow-hidden h-30 sm:h-34">
                            <CardContent className="py-2 px-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    {/* Actions */ }
                                    <div
                                        className="flex items-center gap-2 sm:gap-4 text-muted-foreground text-xs sm:text-base absolute bottom-3 left-3">
                                    ...
                                    <div className="absolute top-3 right-3">
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end" className="w-38 sm:w-32">
                                                <DropdownMenuGroup>
                                                    <DropdownMenuItem onClick={ () => setEditingQuiz(quiz) } className="drop-down-menu-item">
                                                        <Pencil className="size-4"/>
                                                        <p className="flex-1">
                                                            Szerkesztés
                                                        </p>
                                                    </DropdownMenuItem>
                                                                                                        <DropdownMenuItem onClick={ () => handleToggleActive(quiz.id) }
                                                                      className="drop-down-menu-item">
                                                        { quiz.isActive ? <PowerOff className="size-4"/> :
                ...
                <DialogContent className="max-w-sm sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription className="text-sm">
                            Biztosan törölni szeretnéd a(z) &quot;{ deletingQuiz?.title }&quot; kvízt? Ez a művelet nem
                            visszavonható.
                        </DialogDescription>
                    </DialogHeader>
