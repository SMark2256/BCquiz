  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border bg-secondary/30">
        <div className="mx-auto flex h-12 max-w-5xl items-center justify-between px-3 sm:h-14 sm:px-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            {usingMockStorage && (
              <Badge variant="outline" className="gap-1 border-amber-500/50 bg-amber-500/10 px-1.5 py-0.5 text-xs text-amber-600 sm:gap-1.5 sm:px-2">
      ...
      <div className="mx-auto max-w-5xl px-3 py-4 sm:px-4 sm:py-8">
        ...
        {usingMockStorage && (
          <Alert className="mb-4 border-amber-500/50 bg-amber-500/10 sm:mb-6">
            ...
            <AlertDescription className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              ...
              <Button
                ...
                size="sm"
                onClick={resetData}
                className="w-fit shrink-0 text-xs sm:ml-4"
              >
        ...
        <Tabs defaultValue="quizzes">
          <TabsList className="mb-4 w-full sm:mb-6 sm:w-auto">
            <TabsTrigger value="quizzes" className="flex flex-1 items-center gap-1.5 text-xs sm:flex-initial sm:gap-2 sm:text-sm">
              <CalendarDays className="size-3 sm:size-4" />
              <span>Kvízek</span>
            </TabsTrigger>
            <TabsTrigger value="voting" className="flex flex-1 items-center gap-1.5 text-xs sm:flex-initial sm:gap-2 sm:text-sm">
              <Vote className="size-3 sm:size-4" />
